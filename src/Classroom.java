...
public class Classroom {
	...
	/**
	 * The method adds points that have the x and y values of the middle of the answer boxes to an ArrsyList and returns it.
	 * 
	 * @return An ArrayList of points containing the x and y coordinates of the middle of the answer boxes.
	 */
	...
	/**
	 * Returns the index of the correct answer from the problem given to the classroom..
	 * 
	 * @return The index of the correct answer from the problem given to the classroom.
	 */
