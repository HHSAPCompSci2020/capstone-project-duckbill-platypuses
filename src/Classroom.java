...
public class Classroom {
	...
	public void draw(PApplet marker) {
		...
		if (randomProblem.getPossibleAnswers().get(0) != null) {
			marker.text(randomProblem.getPossibleAnswers().get(0), (float) 90, (float) 170);
		}
		if (randomProblem.getPossibleAnswers().get(1) != null) {
			marker.text(randomProblem.getPossibleAnswers().get(1), (float) 90, (float) 480);
		}
		if (randomProblem.getPossibleAnswers().get(2) != null) {
			marker.text(randomProblem.getPossibleAnswers().get(2), (float) 560, (float) 170);
		}
		if (randomProblem.getPossibleAnswers().get(3) != null) {
			marker.text(randomProblem.getPossibleAnswers().get(3), (float) 560, (float) 480);
		}
	}
